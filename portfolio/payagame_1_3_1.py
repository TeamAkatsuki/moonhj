...
def main():
    ...
    font2 = pygame.font.Font('NanumSquareRoundB.ttf', 48)
    font3 = pygame.font.Font('NanumSquareRoundB.ttf', 15)
    font4 = pygame.font.Font('NanumSquareRoundB.ttf',40)
    ...
    SUBTEXT_RECT = SUBTEXT_SURFACE.get_rect(center=(250, 150))

    PUSHTEXT_SURFACE = font3.render('다시뽑기 버튼을 눌러주세요!', True, PINK)
    PUSHTEXT_RECT = PUSHTEXT_SURFACE.get_rect(center=(250, 172))

    FIRST_BOX = pygame.draw.rect(DISPLAY, PINK,(75, 230, 350, 40))
    FIRST_SURFACE = font.render('미트볼이 들어간 로제파스타',True,WHITE)
    FIRST_TEXT = FIRST_SURFACE.get_rect(center=(250,250))
    DISPLAY.blit(FIRST_SURFACE, FIRST_TEXT)

    SECOND_BOX = pygame.draw.rect(DISPLAY, PINK, (75, 300, 350, 40))
    SECOND_SURFACE = font.render("강원도 횡성산 꽃등심 600g",True,WHITE)
    SECOND_TEXT = SECOND_SURFACE.get_rect(center=(250,320))
    DISPLAY.blit(SECOND_SURFACE, SECOND_TEXT)

    THIRD_BOX = pygame.draw.rect(DISPLAY, PINK,(75, 370, 350, 40))
    THIRD_SURFACE = font.render('고베규 스테이크',True,WHITE)
    THIRD_TEXT = THIRD_SURFACE.get_rect(center=(250,390))
    DISPLAY.blit(THIRD_SURFACE, THIRD_TEXT)

    FOURTH_BOX = pygame.draw.rect(DISPLAY, PINK, (75, 440, 350, 40))
    FOURTH_SURFACE = font.render('트러플 오일 파스타',True,WHITE)
    FOURTH_TEXT = FOURTH_SURFACE.get_rect(center=(250,460))
    DISPLAY.blit(FOURTH_SURFACE, FOURTH_TEXT)

    FIFTH_BOX = pygame.draw.rect(DISPLAY, PINK, (75, 510, 350, 40))
    FIFTH_SURFACE = font.render('신라면', True, WHITE)
