...
while True:
    ...
    btn1 = pygame.draw.rect(DISPLAY,(255, 103, 129),(75, 230, 350,40))
    DISPLAY.blit(text[0],textmenu_rect[0])

    btn2 = pygame.draw.rect(DISPLAY,(255, 103, 129),(75, 300, 350,40))
    DISPLAY.blit(text[1],textmenu_rect[1])

    btn3 = pygame.draw.rect(DISPLAY, (255, 103, 129), (75, 370, 350, 40))
    DISPLAY.blit(text[2],textmenu_rect[2])

    btn4 = pygame.draw.rect(DISPLAY,(255, 103, 129),(75, 440, 350,40))
    DISPLAY.blit(text[3],textmenu_rect[3])

    btn5 = pygame.draw.rect(DISPLAY,(255, 103, 129),(75, 510, 350,40))
